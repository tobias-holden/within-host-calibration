...
simulation_output_filepath2 = PROJECT_DIR / "simulation_outputs2" #CURRENT_DIR / "output"
benchmark_simulation_filepath2 = PROJECT_DIR / "simulation_outputs2" #CURRENT_DIR / "output"
