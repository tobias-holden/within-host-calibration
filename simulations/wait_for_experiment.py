...
from helpers import get_comps_id_filename
from get_version import write_to_file
...
def check_experiment(site, platform=None):
    ...
    if not platform:
        platform = Platform(manifest.platform_name,job_directory=manifest.job_directory)
