...
setuptools.setup(
    name="basel-hackathon-2023",
    version="1.0.0",
    author=[author[0] for author in authors],
    author_email=[author[1] for author in authors],
    description="malaria-model_validation adapted for calibration package",
    install_requires=requirements,
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/numalariamodeling/basel-hackathon-2023",
    project_urls={
        "Bug Tracker": "https://github.com/numalariamodeling/basel-hackathon-2023/issues",
    },
    classifiers=[
